...
const happyPeopleImg = null; // Removed missing import: ../assets/happy_people.png
...
const WellnessSection = () => {
    ...
    return (
        <section ref={sectionRef} className="relative w-full py-24 pb-0 overflow-hidden bg-gradient-to-r from-[#050505] via-[#0a0a0a] to-[#050505] animate-gradient-x text-white">
            <div className="max-w-[1400px] 2xl:max-w-[1800px] mx-auto px-6 md:px-12 lg:px-16 mb-24">
            ...
            <div className="w-full border-t border-white/10 bg-black/20 backdrop-blur-sm py-8">
                <div className="max-w-[1400px] 2xl:max-w-[1800px] mx-auto px-8 md:px-16 flex flex-nowrap justify-between items-center gap-6 md:gap-12 overflow-x-auto scrollbar-hide">
