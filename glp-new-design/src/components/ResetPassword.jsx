            ...
            <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black tracking-tighter mb-4 text-[#1a1a1a]">
                        New<br />
                        <span style={{ backgroundColor: '#FFDE59', color: '#1a1a1a', padding: '2px 10px', display: 'inline-block' }}>Credentials.</span>
                    </h1>
                ...
                <div className="bg-[#f9f9f7] border border-black/10 rounded-[40px] p-8 md:p-10 shadow-2xl relative overflow-hidden">
                    {/* Decorative element */}
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFDE5910] rounded-full blur-3xl -mr-16 -mt-16"></div>
                    ...
                    {success ? (
                        <div className="text-center space-y-6 py-4">
                            ...
                            <h3 className="text-xl font-black uppercase tracking-tighter text-[#1a1a1a]">Sync Complete</h3>
                            <p className="text-sm font-bold text-[#1a1a1a] opacity-60 leading-relaxed">
                        ...
                        <form onSubmit={handleUpdatePassword} className="space-y-6">
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-[10px] font-black uppercase tracking-widest mb-3 ml-1 text-[#1a1a1a60]">New Password</label>
                                    <input
                                        type="password"
                                        required
                                        placeholder="••••••••"
                                ...
                                <div>
                                    <label className="block text-[10px] font-black uppercase tracking-widest mb-3 ml-1 text-[#1a1a1a60]">Confirm Password</label>
                                    <input
                                        type="password"
                                        required
                                        placeholder="••••••••"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-6 bg-black text-white rounded-2xl font-black text-xs uppercase tracking-[0.4em] transition-all hover:bg-accent-black hover:text-black disabled:opacity-50 shadow-xl transform active:scale-[0.98]"
                            >
                ...
                {!success && (
                    <div className="mt-8 text-center">
                        <p className="text-[9px] font-bold text-[#1a1a1a30] uppercase tracking-[0.3em]">
