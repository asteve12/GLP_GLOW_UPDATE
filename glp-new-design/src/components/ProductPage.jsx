    ...
    return (
        <div className="relative min-h-screen font-sans text-white">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <div className="max-w-[1400px] 2xl:max-w-[1800px] mx-auto w-[95%] bg-[#F7F8F1] rounded-[40px] md:rounded-[60px] overflow-hidden mt-24 md:mt-32 lg:mt-48 mb-8 md:mb-12 text-bg-primary shadow-2xl relative">
                ...
                {/* SUCCESS STORIES CAROUSEL (Full Width) */}
                {
                    data.richDetails?.successStories && (
                        <section className="success-stories-header w-full py-20 overflow-hidden bg-bg-primary/5 backdrop-blur-sm mb-8 md:mb-12">
                            ...
                            {/* SECTION FOOTER */}
                            <div className="max-w-[1400px] 2xl:max-w-[1800px] mx-auto mt-16 pt-8 border-t border-white/5 flex justify-center opacity-30">
                ...
                {/* WEIGHT LOSS CALCULATOR SECTION */}
                {
                    isWeightLoss && (
                        <section className="calculator-section w-full py-24 md:py-32 bg-[#050505] relative overflow-hidden">
                            ...
                            <div className="max-w-[1400px] 2xl:max-w-[1800px] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
                            ...
                            {/* SECTION FOOTER */}
                            <div className="max-w-[1400px] 2xl:max-w-[1800px] mx-auto mt-24 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 opacity-30">
                ...
                < section className="w-full py-20 md:py-32 bg-white" >
                    <div className="max-w-[1400px] 2xl:max-w-[1800px] mx-auto px-6 md:px-12 lg:px-16">
